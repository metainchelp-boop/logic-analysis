...
;/* ===== js/components/PasswordChangeModal.jsx ===== */
...
window.PasswordChangeModal = function PasswordChangeModal(props) {
  ...
  var _cur = useState('');
  var pwCurrent = _cur[0];
  var setPwCurrent = _cur[1];
  var _new = useState('');
  var pwNew = _new[0];
  var setPwNew = _new[1];
  var _conf = useState('');
  var pwConfirm = _conf[0];
  var setPwConfirm = _conf[1];
  var _msg = useState('');
  var pwMsg = _msg[0];
  var setPwMsg = _msg[1];
  var _load = useState(false);
  var pwLoading = _load[0];
  var setPwLoading = _load[1];
...
window.App = function App() {
  ...
  var renderTopbar = function (activePage) {
    ...
    }, '로그아웃'))), React.createElement(window.PasswordChangeModal, {
      show: showPwModal,
      onClose: function () {
