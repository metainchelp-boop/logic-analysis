...
window.App = function App() {
  ...
  var showPwModal = _pwState[0];
  var setShowPwModal = _pwState[1];
  var _pwCur = useState('');
  var pwCurrent = _pwCur[0];
  var setPwCurrent = _pwCur[1];
  var _pwNew = useState('');
  var pwNew = _pwNew[0];
  var setPwNew = _pwNew[1];
  var _pwConfirm = useState('');
  var pwConfirm = _pwConfirm[0];
  var setPwConfirm = _pwConfirm[1];
  var _pwMsg = useState('');
  var pwMsg = _pwMsg[0];
  var setPwMsg = _pwMsg[1];
  var _pwLoading = useState(false);
  var pwLoading = _pwLoading[0];
  var setPwLoading = _pwLoading[1];
  ...
  var handleChangePassword = function () {
    if (!pwCurrent || !pwNew) {
      setPwMsg('현재 비밀번호와 새 비밀번호를 입력하세요.');
      return;
    }
    if (pwNew.length < 6) {
    ...
    api.put('/auth/change-password', {
      ...
      setPwLoading(false);
      setPwMsg(e.message || '네트워크 오류');
    });
  };
  var renderPwModal = function () {
    if (!showPwModal) return null;
    return React.createElement('div', {
      style: _pwModalOverlay,
      onClick: function (e) {
        if (e.target === e.currentTarget) setShowPwModal(false);
      }
    }, React.createElement('div', {
      className: 'pw-modal-inner',
      style: _pwModalBox
    }, React.createElement('h3', {
      style: {
        color: '#6B21A8',
    ...
    }, '🔒 비밀번호 변경'), pwMsg && React.createElement('div', {
      style: {
        padding: '8px 12px',
        borderRadius: 6,
        marginBottom: 12,
        fontSize: 13,
        background: pwMsg.includes('변경되었습니다') ? '#D1FAE5' : '#FEE2E2',
        color: pwMsg.includes('변경되었습니다') ? '#065F46' : '#991B1B'
      }
      ...
      style: _pwLabelStyle
    }, '현재 비밀번호'), React.createElement('input', {
      type: 'password',
      value: pwCurrent,
      onChange: function (e) {
      ...
      style: _pwLabelStyle
    }, '새 비밀번호'), React.createElement('input', {
      type: 'password',
      value: pwNew,
      onChange: function (e) {
      ...
      style: _pwLabelStyle
    }, '새 비밀번호 확인'), React.createElement('input', {
      type: 'password',
      value: pwConfirm,
      onChange: function (e) {
      ...
      disabled: pwLoading,
      style: Object.assign({}, _pwSubmitBtn, {
  ...
  var renderTopbar = function (activePage) {
    ...
    currentUser.role === 'superadmin' && React.createElement('button', {
      ...
      style: navBtn(activePage === 'settings')
  ...
  /* 홈 탭 — 업체 리스트 + 검색 */
  if (currentPage === 'home') return React.createElement(React.Fragment, null, React.createElement('div', null, renderTopbar('home'), React.createElement(SearchBar, {
  ...
  if (currentPage === 'management') return React.createElement(React.Fragment, null, React.createElement('div', null, renderTopbar('management'), React.createElement(window.ClientDashboard, {
    currentUser: currentUser,
  ...
  if (currentPage === 'guide') return React.createElement(React.Fragment, null, React.createElement('div', null, renderTopbar('guide'), React.createElement(window.UserGuidePage, {
    currentUser: currentUser
  })), React.createElement(window.ChatWidget, {
    currentUser: currentUser
  }));
  if (currentPage === 'users' && (currentUser.role === 'admin' || currentUser.role === 'superadmin')) return React.createElement(React.Fragment, null, React.createElement('div', null, renderTopbar('users'), React.createElement(window.UserManagementPage, {
    currentUser: currentUser,
    token: authToken
  })), React.createElement(window.ChatWidget, {
    currentUser: currentUser
  }));
  if (currentPage === 'settings' && currentUser.role === 'superadmin') return React.createElement(React.Fragment, null, React.createElement('div', null, renderTopbar('settings'), React.createElement('div', {
    style: {
      maxWidth: 1000,
      margin: '0 auto',
      padding: '24px 16px'
  ...
  renderTopbar('analysis'), React.createElement(SearchBar, {
