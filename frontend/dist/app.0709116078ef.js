...
window.PlaceAnalysisPage = function PlaceAnalysisPage(props) {
  ...
  var ai = _ai[0],
    setAi = _ai[1];
  var _ax = useState(true);
  var aiExpanded = _ax[0],
    setAiExpanded = _ax[1];
  var _cs = useState([]);
  ...
  var _eb = useState(false);
  var exportBusy = _eb[0],
    setExportBusy = _eb[1];
  var _ec = useState('');
  var exportCompany = _ec[0],
    setExportCompany = _ec[1];
  useEffect(function () {
    if (businessName) setExportCompany(businessName);
  }, [businessName]);
  ...
  var renderCover = function () {
    return React_.createElement(React_.Fragment, null, React_.createElement('div', {
      ...
      className: 'rc-title'
    }, '플레이스 분석 보고서')), React_.createElement('div', {
      className: 'rc-grid'
    }, React_.createElement('div', {
      className: 'rc-field'
    }, React_.createElement('div', {
      className: 'rc-k'
    }, '광고주 / 업체'), React_.createElement('div', {
      className: 'rc-v'
    }, result.business_name || businessName || '-')), React_.createElement('div', {
      className: 'rc-field'
    }, React_.createElement('div', {
      className: 'rc-k'
    }, '분석 키워드'), React_.createElement('div', {
      className: 'rc-v'
    }, result.keyword || selectedKw || '-')), React_.createElement('div', {
      className: 'rc-field'
    }, React_.createElement('div', {
      className: 'rc-k'
    }, '지역'), React_.createElement('div', {
      className: 'rc-v'
    }, (result.region || region || '미지정') + (result.category ? ' · ' + result.category : ''))), React_.createElement('div', {
      className: 'rc-field'
    }, React_.createElement('div', {
      className: 'rc-k'
    }, '분석일'), React_.createElement('div', {
      className: 'rc-v'
    }, (result.analyzed_at || '').slice(0, 10) || new Date().toLocaleDateString('ko'))))), React_.createElement('div', {
      className: 'report-legend'
    }, React_.createElement('b', {
      className: 'badge b-ok'
    }, '✅ 실측'), ' 캡처 검색결과 실제값', React_.createElement('span', {
      className: 'rl-sep'
    }, '·'), React_.createElement('b', {
      className: 'badge b-est'
    }, '≈ 추정'), ' 계산·근거 기반', React_.createElement('span', {
      className: 'rl-sep'
    }, '·'), React_.createElement('b', {
      className: 'badge b-ai'
    }, 'AI'), ' AI 생성'), React_.createElement('div', {
      className: 'anchor-nav-wrap'
    }, React_.createElement('div', {
      className: 'container'
    }, React_.createElement('div', {
  ...
  var renderSaveCard = function () {
    ...
    return React_.createElement('section', {
      id: 'sec-save-client',
      className: 'section'
    }, React_.createElement('div', {
      className: 'container'
  ...
  var renderReportSection = function () {
    return React_.createElement('div', {
    ...
    }, '📄'), '보고서 내보내기'), React_.createElement('div', {
      className: 'section-line'
    }), React_.createElement('p', {
      className: 'section-subtitle'
    }, '분석 결과를 광고주 전달용 HTML 보고서로 다운로드합니다'), React_.createElement('div', {
      className: 'card'
    }, React_.createElement('div', {
      style: {
        display: 'flex',
    ...
    }, React_.createElement('label', {
      className: 'form-label'
    }, '업체명 (선택)'), React_.createElement('input', {
      className: 'form-input',
      style: {
        width: 160
      },
      ...
      value: exportCompany,
      onChange: function (e) {
        setExportCompany(e.target.value);
      }
    })), React_.createElement('button', {
      className: 'btn btn-primary',
      onClick: handleHtmlExport,
      disabled: exportBusy
    }, exportBusy ? '생성 중...' : '📄 HTML 보고서 다운로드')), React_.createElement('div', {
      style: {
        marginTop: 12,
        padding: '10px 14px',
        background: '#f0f9ff',
  ...
  var renderSec5Opp = function () {
    ...
    return React_.createElement(React_.Fragment, null, React_.createElement(window.SectionDivider, {
      ...
      className: 'rt-desc'
    }, React_.createElement('b', null, '이 지역에서 실제로 검색되는데 아직 순위가 없는'), ' 키워드만 제시합니다. 이미 노출 중인 키워드는 「지킬 것」이라 뺐고, ', React_.createElement('b', null, '지역 결합 검색량이 확인되지 않은'), ' 키워드도 뺐습니다. 그대로 ', React_.createElement('b', null, '플레이스 추적'), '에 등록하면 다음 날부터 순위 기록이 쌓입니다.'), React_.createElement('div', {
      className: 'twrap'
      ...
      className: 'n'
    }, '이 지역 검색량'), React_.createElement('th', {
      className: 'n'
    }, '전체 시장'), React_.createElement('th', null, '경쟁'), React_.createElement('th', null, '현재'), React_.createElement('th', null, '판단'))), React_.createElement('tbody', null, gold.map(function (r, i) {
      return React_.createElement('tr', {
        key: i
      }, React_.createElement('td', {
        style: {
        ...
        className: 'n'
      }, (r.volume || 0).toLocaleString()), React_.createElement('td', {
        className: 'n',
        style: {
          color: 'var(--pa-muted)'
        }
      }, r.baseVolume != null ? r.baseVolume.toLocaleString() : '—'), React_.createElement('td', null, r.compIdx || '—'), React_.createElement('td', null, r.state || '미확인'), React_.createElement('td', null, React_.createElement('span', {
    ...
    }, React_.createElement('b', null, '「전체 시장」과 「이 지역 검색량」이 크게 다른 이유:'), ' 전체 시장은 지역을 뺀 키워드의 전국 검색량입니다. 동네 장사는 ', React_.createElement('b', null, '이 지역 검색량'), '이 실제 손님 수요이고, 전체 시장은 업종 크기를 가늠하는 참고치입니다.')) : null, rel.length ? React_.createElement('div', {
      className: 'card',
      style: {
      ...
      className: 'rt-desc'
    }, '‘', m.baseKeyword || '', '’ 에서 파생된 연관 키워드와, 여기에 지역을 결합한 실제 공략 키워드입니다. ', React_.createElement('b', null, '결합 검색량이 「20」'), ' 이면 검색광고의 최저 표기 = 그 지역에서는 사실상 검색되지 않는다는 뜻입니다.'), React_.createElement('div', {
      className: 'twrap'
  ...
  var _aiInline = function (s) {
    return String(s || '').replace(/\*\*\*([^*]+)\*\*\*/g, '$1') // ***강조*** 를 먼저 — ** 규칙만 있으면 *강조* 별 1쌍이 잔류(검증에서 확인)
  ...
  var renderAiText = function (txt) {
    ...
    String(txt || '').split('\n').forEach(function (line, i) {
      ...
      if (mHead) {
        ...
        if (ht) out.push(React_.createElement('div', {
          key: 'h' + i,
          style: {
            fontWeight: 800,
            color: 'var(--pa-ink)',
  ...
  var renderSec4 = function () {
    ...
    }, React_.createElement('div', null, React_.createElement('h3', {
      className: 'rt-h3'
    }, React_.createElement('span', {
      className: 'rt-hic'
    }, '🤖'), 'METAINC AI 종합 분석 리포트', React_.createElement('span', {
      className: 'badge b-ai'
    }, 'AI')), React_.createElement('div', {
      className: 'rt-desc'
    }, '"' + (result.keyword || selectedKw || '') + '" 플레이스 상위노출 로직(적합도·인기도·거리)을 AI가 종합해 작성한 진단')), React_.createElement('div', {
      style: {
        display: 'flex',
        gap: 8,
        alignItems: 'center',
    ...
    }, aiExpanded ? '접기' : '펼치기'), !aiLoading && React_.createElement('button', {
      onClick: function () {
        fetchAi(result);
      },
      style: {
    ...
    }, ai ? '다시 분석' : '✨ AI 종합 분석'), /* no-export: 상태 마커가 실패해도 로딩 문구만은 전달본에서 항상 제거(이중 방어) */
    ...
    ai && aiExpanded && React_.createElement('div', {
      style: {
        display: 'flex',
        flexDirection: 'column',
        gap: 16,
      ...
      }, s.icon), React_.createElement('span', {
        style: {
          fontSize: 14,
          fontWeight: 700,
          color: isSummary ? '#b45309' : '#0369a1'
    ...
    })), !ai && !aiLoading && React_.createElement('div', {
      className: 'note',
      style: {
        marginTop: 10
      }
    }, 'AI 종합 진단은 분석 실행 후 자동 생성됩니다. 「✨ AI 종합 분석」으로 다시 생성할 수 있습니다.'), React_.createElement('div', {
      className: 'note',
      style: {
        marginTop: 13
      }
  ...
  return React_.createElement('div', {
    ...
    className: 'pa-wrap'
  }, renderInput(), !result && React_.createElement('div', {
    className: 'card',
    style: {
      textAlign: 'center',
      color: '#94a3b8',
  ...
  }, '오프라인·지역 업종(카페·식당·병원·미용 등)의 플레이스 상위노출 경쟁력을 진단합니다.'))), result && React_.createElement('div', {
    className: 'report-shell'
  }, /* 좌측 고정 목차 (와이드 화면 전용) — 스토어와 동일 마크업 */
  React_.createElement('nav', {
    className: 'report-toc'
  }, React_.createElement('div', {
    className: 'report-toc-title'
  }, '목차'), TOC_SECTIONS.map(function (s) {
    return React_.createElement('a', {
      key: s.id,
      className: 'report-toc-link',
      onClick: function () {
        scrollToSec(s.id);
    ...
    className: 'report-toc-legend'
  }, React_.createElement('div', null, React_.createElement('b', {
    className: 'badge b-ok'
  }, '✅ 실측'), ' 캡처 검색결과 실제값'), React_.createElement('div', null, React_.createElement('b', {
    className: 'badge b-est'
  }, '≈ 추정'), ' 계산·근거기반'), React_.createElement('div', null, React_.createElement('b', {
    className: 'badge b-ai'
