        ...
        React.createElement('div', { className: 'container' },
            ...
            showComp && advertiserData && React.createElement('div', { style: {
                ...
                React.createElement('div', { style: { flex: 1, minWidth: 200 } },
                    ...
                    }, productInfo.product_name || '상품 정보를 불러오지 못했습니다'),
                    productInfo.product_name
                        ...
                        : React.createElement('div', {
                            style: {
                                fontSize: 12.5, color: '#78350f', background: '#fffbeb',
                                border: '1px solid #fde68a', borderRadius: 8, padding: '9px 11px', marginTop: 2
                            }
                          },
                            React.createElement('div', { style: { fontWeight: 700, marginBottom: 3 } },
                                '네이버가 쇼핑 검색 API 를 종료해(2026-07-31) 아직 수집되지 않은 키워드는 상품 정보를 가져올 수 없습니다.'),
                            React.createElement('div', null,
                                '기다려도 채워지지 않습니다. 아래 경쟁사·격차 분석도 같은 이유로 비어 있을 수 있습니다.'))
                ),
